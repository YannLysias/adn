                        ...
                        <div class="x_content">
                            ...
                            <form class="" action="/inscrire" method="post"
                                ...
                                <div class="field item form-group">
                                    ...
                                    <div class="col-md-6 col-sm-6">
                                        <input class="form-control" type="number" class='tel'
                                            name="npi" data-validate-length-range="10,20" placeholder="Pas obligatoire" value="{{ old('npi') }}" />
                                    </div>
                                    @error('npi')
                                    <div class="d-block text-danger">{{$message}}</div>
                                    @enderror
                                ...
                                <div class="field item form-group">
                                    ...
                                    <div class="col-md-6 col-sm-6">
                                        <input class="form-control" type="number" class='tel'
                                            name="ravip" data-validate-length-range="10,20" placeholder="Pas obligatoire" value="{{ old('ravip') }}" />
                                    </div>
                                    @error('ravip')
                                    <div class="d-block text-danger">{{$message}}</div>
                                    @enderror
